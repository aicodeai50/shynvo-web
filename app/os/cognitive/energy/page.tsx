  ...
  switch (band) {
    case "Low":
      return {
        mode: "Stabilize",
        focus: "12-18 min",
        breakType: "2-4 min walk / water / reset",
        prompt: "Shrink scope. One tiny deliverable. Win momentum before intensity.",
      };
    case "Medium":
      return {
        mode: "Build",
        ...
        prompt: "Choose one objective. Keep it crisp. Aim for progress, not perfection.",
      };
    case "High":
      return {
        mode: "Sprint",
        focus: "45-60 min",
        breakType: "8-12 min full disconnect",
        prompt: "Use the peak. Deep work only. No context switching. Protect the run.",
      };
  }
}
    ...
    >
      ...
      <div className="mt-4 rounded-xl border border-white/10 bg-black/30 p-4">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          <Link href="/os/cognitive" className="rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-sm text-white/80 hover:bg-white/10">
            Back to hub
          </Link>
          <Link href="/os/cognitive/friction" className="rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-sm text-white/80 hover:bg-white/10">
            Go to Friction
          </Link>
          <Link href="/os/cognitive/recovery" className="rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-sm text-white/80 hover:bg-white/10">
            Go to Recovery
          </Link>
          <Link href="/os/cognitive/stuck" className="rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-sm text-white/80 hover:bg-white/10">
            Go to Stuck
          </Link>
        </div>
      </div>
