      ...
      <div className="relative mx-auto max-w-5xl px-6 py-14">
        <div className="flex items-center justify-between gap-3">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-bold">Chrono Vault</h1>
            <p className="mt-3 text-white/70">
              Coming soon. This experiment simulates “future you” with branching timelines.
            </p>
          </div>
        ...
        <div className="mt-10 rounded-3xl border border-white/10 bg-black/50 p-8 backdrop-blur">
          ...
          <ul className="mt-4 list-disc space-y-2 pl-5 text-sm text-white/80">
            <li>Future-self narrative simulation</li>
            <li>Branching choices + timeline outcomes</li>
            <li>Reflective prompts + emotional guidance</li>
            <li>Shareable “timeline cards”</li>
          </ul>
        </div>
      </div>
    </div>
