...
export default function Page() {
  ...
  return (
    <section className="py-10 sm:py-14">
      ...
      <h1 className="mt-4 text-3xl font-semibold">Active Missions</h1>
      <p className="mt-3 max-w-3xl text-white/70">
        This page shows the mission that is currently active and ready to be executed through Timeline and Focus.
      </p>

      <div className="mt-8 rounded-2xl border border-white/10 bg-black/20 p-4 text-white/80 whitespace-pre-wrap">
        {snapshot?.mission || "No active mission yet."}
      </div>
    </section>
  );
}
