...
export default function Page() {
  ...
  return (
    <section className="py-10 sm:py-14">
      ...
      <h1 className="mt-4 text-3xl font-semibold">This Week</h1>
      <p className="mt-3 max-w-3xl text-white/70">
        This page shows how work is distributed across the week so execution stays realistic and balanced.
      </p>

      <div className="mt-8 rounded-2xl border border-white/10 bg-black/20 p-4 text-white/80">
        {snapshot?.week || "No weekly timeline has been saved yet."}
      </div>
    </section>
  );
}
